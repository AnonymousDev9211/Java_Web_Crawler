...
public class FileUtilsTest {
    ...
    public void testSaveWordTableNull() throws Exception {
        if (this.fu.getClass().getDeclaredMethod("saveWordTable", List.class, String.class).getExceptionTypes().length > 0) {
            fail("saveWordTable() should not be throwing any exceptions!");
        } //end if
    ...
    public void testSavePageTableNull() throws Exception {
        if (this.fu.getClass().getDeclaredMethod("savePageTable", List.class, String.class).getExceptionTypes().length > 0) {
            fail("savePageTable() should not be throwing any exceptions!");
        } //end if
    ...
    public void testGetWordListNull() throws Exception {
        if (this.fu.getClass().getDeclaredMethod("getWordList", String.class).getExceptionTypes().length > 0) {
            fail("getWordList() should not be throwing any exceptions!");
        } //end if
    ...
    public void testGetPageListNull() throws Exception {
        if (this.fu.getClass().getDeclaredMethod("getWordList", String.class).getExceptionTypes().length > 0) {
            fail("getPageList() should not be throwing any exceptions!");
        } //end if
